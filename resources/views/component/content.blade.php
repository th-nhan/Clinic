    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/GUb8uUZUh5A?si=IoJKFvArXlfiOkb5"
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <img src="https://jetdentist.vn/upload/news/b%C3%ACa_(1)4.jpg_1684914954.webp" class="card-img-top"
                        alt="Vệ sinh vô khuẩn">
                    <div class="card-body">
