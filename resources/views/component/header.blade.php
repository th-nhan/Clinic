...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm p-0 fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse  navbar-collapse" id="navbarNav">
            ...
            <div class="pb-2  pe-2">
                <div
                    class="border  border-primary rounded-circle w-30 h-30 d-flex justify-content-center align-items-center">
                    <img src="pic/bs1.jpg" alt="avatar" class="rounded-circle " width="30px" height="30px">
                </div>
            </div>
